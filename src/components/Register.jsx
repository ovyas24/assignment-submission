                                ...
                                <div className="col-lg-12">
                                    <div className="p-5">
                                        ...
                                        <form className="user" onSubmit={handleLogin}>
                                            ...
                                            </div><button className="btn btn-primary d-block btn-user w-100" type="submit">Signup</button>
                                            <hr />
                                        </form>
                                        <div className="text-center"><Link to="/login"  className="small" >Already have an Account!</Link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
